                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                        <tr>
                                            <td valign="top" class="bodyContent">        
                                                ...
                                                <p>Dear <?php echo $account_name; ?>,</p>
                                                <p>Your account has been <?php echo $type;?> with amount <?php echo number_format($amount, 2, '.', ',');?> PKR.</p>
                                                <p>Your new balance is: <?php echo number_format($balance, 2, '.', ',');?></p>
