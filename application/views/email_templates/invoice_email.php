                                        ...
                                        <tr>
                                            <td valign="top" class="headerContent">
                                                <a href="<?php echo base_url();?>">
                                                    <img src="https://alisofttech.com/webfiles/images/logo.png" style="max-width:600px;padding:20px 20px 0 20px" id="headerImage" alt="Ali Softtech" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                        <tr>
                                            <td valign="top" class="bodyContent">        
                                                ...
                                                <p>Dear <?php echo $account['name']; ?>,</p>
                                                <p>This is a notice that an invoice has been generated on <?php echo $invoice['date']; ?>.</p>
                                                <p>Invoice # <?php echo $invoice['invoice_id']; ?><br />Amount Due: <?=number_format($balance, 2, '.', ',');;?></p>
                                                <p><strong>Invoice Items</strong></p>
                                                <table style="border-collapse: collapse; width: 100%;" border="1">
                                                <tbody>
                                                <tr>
                                                <td style="width: 8.3333%; text-align: center;"><span class="example1 example2">Sn</span></td>
                                                <td style="width: 58.3333%; text-align: center;"><span class="example1 example2">Title</span></td>
                                                <td style="width: 33.3333%; text-align: center;"><span class="example1 example2">Amount</span></td>
                                                </tr>
                                                <?php 
                                                $sn =0;
                                                $totalAmount = 0;
                                                ...
                                                $sn++;?>
                                                <tr>
                                                    <td style="width: 8.3333%;"><?=$sn;?></td>
                                                    <td style="width: 58.3333%;"><?=$row['description'];?></td>
                                                    <td style="text-align:center;width: 33.3333%;"><?=number_format($row['amount'], 2, '.', ',');;?></td>
                                                </tr>
                                                <?php } ?>
                                                <tr>
                                                <td colspan="2"></td>
                                                ...
                                                <p>&nbsp;</p>
                                                <p>You can view invoice from atteched pdf files and can pay invoice using our payment methods mentioned on&nbsp;<a href="https://alisofttech.com/payments/">https://alisofttech.com/payments/</a></p>
                                                <p>Kindest Regards,<br />Ali Softtech (Pvt.) Ltd.<br />www.alisofttech.com</p>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                        <tr>
                                            <td valign="top" class="footerContent">
                                                Copyright &copy; Ali Softtech, All rights reserved.
                                            </td>
                                        </tr>
                                    </table>
                                </td>
