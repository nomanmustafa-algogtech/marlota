                ...
                <div class="container">
                    <div class="tab tab-vertical row gutter-lg">
                        <ul class="nav nav-tabs mb-6" role="tablist">
                            <li class="link-item">
                                <a href="<?=base_url();?>user/account" class="active">Dashboard</a>
                            </li>
                            <li class="link-item">
                        ...
                        <div class="tab-content mb-6">
                            <div class="tab-pane active in" id="account-dashboard">
                                ...
                                <p class="greeting">
                                    Hello
                                    <span class="text-dark font-weight-bold"><?=$userData['full_name'];?></span>
                                    (Balance: <?=$userData['balance'];?>)
                                    <!--<span style="float: right;color:black;">Referral Code: <?=$userData['referral_code'];?> <a href="javascript:avoid(0);" onclick="window.open('<?=base_url();?>user/refqrcode','Qr Code','toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=500,height=500');" >(View QR Code)</a></span>-->
                                </p>

                                <p class="mb-4">
                                    From your account dashboard you can view your <a href="#"
                                        class="text-primary ">recent orders</a>, <a href="<?=base_url();?>user/referrals"
                                        class="text-primary ">view referrals</a>,
                                    manage your <a href="#" class="text-primary">shipping
                                        and billing
                                        addresses</a>, and
                                    <a href="#" class="text-primary">edit your password and
                                        account details.</a>
                                </p>

                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 mb-4">
                                        <a href="<?=base_url();?>user/orders" class="link-to-tab">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 mb-4">
                                        <a href="#" class="link-to-tab">
                                            <div class="icon-box text-center">
                                                <span class="icon-box-icon icon-user">
                                                    <i class="w-icon-user"></i>
                                                </span>
                                                <div class="icon-box-content">
                                                    <p class="text-uppercase mb-0">(<?=$this->db->query("SELECT * FROM app_referrals WHERE user_id = '{$userData['id']}'")->num_rows();?>) Referrals</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
