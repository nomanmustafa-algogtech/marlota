                                                    ...
                                                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-12">
                                                               ...
                                                               <select name="zone_id" id="zone_id" class="form-control select2" required disabled>
                                                                   <option value="">Select Zone</option>
                                                                   <?php foreach($cities as $row){ ?>
                                                                        <option value="<?=$row['id'];?>" <?php if($zones['id'] ==  $row['id'] ){ echo 'selected'; } ?>><?=$row['name'];?></option>
                                                                   <?php } ?>
                                                               </select>
                                                            </div>
                                                        </div>
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" id="name" name="name" class="form-control" value="<?=$zones['name'];?>" placeholder="" required>
                                                            </div>
                                                        </div>
