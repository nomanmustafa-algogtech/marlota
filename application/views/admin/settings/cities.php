                                                            ...
                                                            <tbody class="row_position">
                                                                ...
                                                                <tr id="<?php echo $row['id']; ?>" style="cursor: move;">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a  href="<?=base_url();?>admin/settings/zones/?city_id=<?=$row['id'];?>" class="btn btn-success btn-xs waves-effect waves-light">Zones</a>
                                                                        <?php if($row['status'] == 1){ ?>
                                                                        <a href="<?=base_url('admin/settings/disable_city/'.$row['id']);?>" class="btn btn-danger btn-xs waves-effect waves-light">Disable</a>
                                                                        <?php }else{ ?>
                                                                        <a href="<?=base_url('admin/settings/enable_city/'.$row['id']);?>" class="btn btn-primary btn-xs waves-effect waves-light">Enable</a>
                                                                        <?php } ?>
                                                                    </td>
                                                                </tr>
                                                                <?php } ?>
