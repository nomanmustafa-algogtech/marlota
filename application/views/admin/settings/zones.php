                                                            ...
                                                            <tbody class="row_position">
                                                                ...
                                                                <tr id="<?php echo $row['id']; ?>" style="cursor: move;">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a  href="<?=base_url('admin/settings/edit_zone/'.$row['id'].'/'.$row['city_id']);?>" class="btn btn-info btn-xs waves-effect waves-light">Edit</a>
                                                                        <a href="<?=base_url('admin/settings/delete_zone/'.$row['id'].'/'.$row['city_id']);?>" class="btn btn-danger btn-xs waves-effect waves-light">Delete</a>
                                                                        <?php if($row['status'] == 1){ ?>
