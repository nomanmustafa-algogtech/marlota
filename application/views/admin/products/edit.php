    ...
    border: 1px solid #3aafda;
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <form class="form-horizontal" role="form" action="" onsubmit="<?php if($product['vendor_id']!=0){ echo 'return false'; }?>" id="choice_form" enctype="multipart/form-data" method="post">
                            <div class="row">
                            <div class="col-1"></div>
                            <div class="col-10">
                                <div class="card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="p-2">
                                                        ...
                                                        <div class="mb-2 row">
                                                            <div class="col-md-12">
                                                                <label class="col-form-label" for="supplier_id">Select Supplier</label>
                                                                <select class="select2 form-control" name="supplier_id" id="supplier_id" required>
                												    <option value="">Select Supplier</option>
                												    <?php 
                												    foreach($suppliers as $row){
                                                                        
                                                                            echo getOptions($row, 1, $product['supplier_id']);
                                                ...
                                                <div class="col-12">
                                                    <div class="p-2">
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <label class="col-form-label" for="featured">Trending Status</label>
                                                                <select class="select2 form-control" name="featured" id="featured" required>
                												    <option value="1" <?php if($product['featured'] == 1){ echo 'selected'; } ?>>Trending </option>
                												    <option value="0" <?php if($product['featured'] == 0){ echo 'selected'; } ?>>Not Trending</option>
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <label class="col-form-label" for="bestseller">Best Seller</label>
                                                                <select class="select2 form-control" name="bestseller" id="bestseller" required>
                												    <option value="1" <?php if($product['bestseller'] == 1){ echo 'selected'; } ?>>Best Seller</option>
                												    <option value="0" <?php if($product['bestseller'] == 0){ echo 'selected'; } ?>>Not Best Seller</option>
