                                                            ...
                                                            <tbody class="row_position">
                                                                ...
                                                                <tr id="<?php echo $row['id']; ?>" style="cursor: move;">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <button type="button" onclick="window.location.href='<?=base_url();?>admin/products/attribute_edit/value/<?=$row['id'];?>';" class="btn btn-success btn-bordered rounded-pill btn-xs waves-effect waves-light"><i class="ri-edit-box-line"></i></button>
                                                                        <button type="button" onclick="if(confirm('Are you sure you want to delete this value?')){ window.location.href='<?=base_url();?>admin/products/attribute_delete/value/<?=$row['id'];?>/?att_id=<?=$row['attribute_id'];?>'; }" class="btn btn-danger btn-bordered rounded-pill btn-xs waves-effect waves-light"><i class="ri-delete-bin-line"></i></button>
