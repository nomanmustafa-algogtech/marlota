                                        ...
                                        <table  class="table dt-responsive nowrap w-100 basic-datatable">
                                                            ...
                                                            <tbody class="row_position">
                                                                ...
                                                                <tr id="<?php echo $row['id']; ?>" style="cursor: move;">
                                                                    ...
                                                                    <td>
                                                                        <button type="button" onclick="window.location.href='<?=base_url();?>admin/products/attribute_values/<?=$row['id'];?>';" class="btn btn-primary btn-bordered rounded-pill btn-xs waves-effect waves-light"><i class="ri-settings-2-line"></i></button>
                                                                        <button type="button" onclick="window.location.href='<?=base_url();?>admin/products/attribute_edit/name/<?=$row['id'];?>';" class="btn btn-success btn-bordered rounded-pill btn-xs waves-effect waves-light"><i class="ri-edit-box-line"></i></button>
                                                                        <button type="button" onclick="if(confirm('Are you sure you want to delete this attribute?')){ window.location.href='<?=base_url();?>admin/products/attribute_delete/name/<?=$row['id'];?>'; }" class="btn btn-danger btn-bordered rounded-pill btn-xs waves-effect waves-light"><i class="ri-delete-bin-line"></i></button>
