                                                ...
                                                <div class="p-2">
                                                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="text" id="fullname" name="fullname" value="<?=$user['fullname'];?>" class="form-control" placeholder="e.g Mian Ali" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="text" id="username" name="username"  value="<?=$user['username'];?>" class="form-control" placeholder="e.g mianalise" readonly required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="text" id="email" name="email" class="form-control"  value="<?=$user['email'];?>" placeholder="e.g info@alisofttech.com" readonly required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="text" id="password" name="password" class="form-control" placeholder="e.g JA7^%@$3">
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="text" id="phone" name="phone" class="form-control"  value="<?=$user['phone'];?>" placeholder="e.g +92 300 1234567">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-3 imgUp">
                                                                <div class="imagePreview" style="<?php if($user['profile_pic']!=''){ echo 'background-image: url('.base_url().'uploads/profile_pics/admin/'.$user['profile_pic'].');'; } ?>"></div>
