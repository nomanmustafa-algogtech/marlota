                                                                ...
                                                                <tbody class="row_position">
                                                                    ...
                                                                    <tr id="<?php echo $row['id']; ?>">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a  href="<?=base_url();?>admin/products/edit/<?=$row['id'];?>" class="btn btn-success btn-xs waves-effect waves-light">Edit</a>
                                                                            <a href="<?=base_url('admin/products/delete_product/'.$row['id']);?>" class="btn btn-danger btn-xs waves-effect waves-light" onclick="return confirm('Are you sure you want to delete this product?')">Delete</a>
                                                                        </td>
                                                                    </tr>
                                                                    <?php }}else{ ?>
                                                                    <tr>
