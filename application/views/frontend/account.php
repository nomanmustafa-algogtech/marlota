    ...
    <section class="blog about-blog">
        <div class="container">
            <div class="blog-bradcrum">
                ...
                <span><a href="<?=base_url();?>/user/account">Dashboard</a></span>
            </div>
        </div>
    </section>
            ...
            <div class="user-profile-section">
                ...
                <div class="user-dashboard">
                    <div class="nav nav-item nav-pills  me-3" id="v-pills-tab" role="tablist"
						...
						<button class="nav-link" id="v-pills-review-tab" data-bs-toggle="pill" data-bs-target="#v-pills-review" type="button" role="tab" aria-controls="v-pills-review" aria-selected="false" tabindex="-1">
                            <span>
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                            ...
                            <div class="user-profile">
                                <div class="user-title">
									 <h5 class="heading mb-4">Welcome to your Profile </h5>
									<p class="paragraph">
										Hello
									 ...
									 <p class="paragraph">
										From your account dashboard you can view your <a href="#"
											class="text-primary ">recent orders</a>, 
                                    ...
                                    <div class="row g-5">
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="product-wrapper">
                                                ...
                                                <div class="wrapper-content">
                                                    ...
                                                    <h3 class="heading"><?php echo count($orders) ?></h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="product-wrapper">
                                                <div class="wrapper-img">
                                                    <span>
                                                          <svg width="62" height="62" viewBox="0 0 16 14" fill="none"
																xmlns="http://www.w3.org/2000/svg">
																<g clip-path="url(#clip0_113_3017)">
																	<path
																		d="M8.00893 1.94252C8.25673 1.67321 8.45526 1.43486 8.67664 1.22099C10.387 -0.427293 13.0628 -0.40281 14.7246 1.2714C16.3985 2.95785 16.4356 5.687 14.7674 7.39721C12.6907 9.52652 10.5848 11.6263 8.48882 13.7369C8.13819 14.0897 7.85825 14.0876 7.50619 13.7326C5.4188 11.6306 3.32426 9.53588 1.25187 7.41953C-0.424185 5.70788 -0.410617 2.98738 1.25258 1.293C2.92721 -0.413611 5.62304 -0.434494 7.35265 1.24836C7.56475 1.4543 7.76042 1.67825 8.00893 1.94252Z" />
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="product-wrapper">
                                                ...
                                                <div class="wrapper-content">
                                                    <p class="paragraph">Referrals</p>
                                                    <h3 class="heading"><?php 
														$count_referrals = $this->db
															->query("SELECT * FROM app_referrals WHERE user_id = '{$userData['id']}'")
															->num_rows();
														echo $count_referrals; ?>
													</h3>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="cart-section">
                                <div class="container">
                                    ...
                                    if (count($orders) < 1){
                                        ...
                                        <div class="col-md-3 price-product" style="text-align:right">
                                        ...
                                        <div class="row">
                                          <div class="col-md-6 text-start">
												<span class="fw-bold me-1" style="font-size:16px;">Paid By:</span>
												<?php
													$methods = [
														1 => ['label' => 'Cash on Delivery', 'class' => 'badge bg-secondary fs-6'],
														2 => ['label' => 'Credit Card', 'class' => 'badge bg-primary fs-6'],
														3 => ['label' => 'Paypal', 'class' => 'badge bg-info text-dark fs-6']
													];

													$method = $methods[$row['payment_method']] ?? ['label' => 'Unknown', 'class' => 'badge bg-dark fs-6'];
												?>
												<span class="<?= $method['class']; ?>"><?= $method['label']; ?></span>
											</div>

                                            <div class="col-md-6" style="text-align:right;">
                                                <span style="font-weight:bold; font-size: 16px;">Shipping Cost: £ <?=$row['shipping_cost'];?> </span>
                                            </div>
                                              <div class="col-md-12" style="text-align:right;">
                                                <span style="font-weight:bold; font-size: 16px;">VAT: £ <?=$row['vat'];?> </span>
                                            </div>
                                            <div class="col-md-12" style="text-align:right;">
                                                <span style="font-weight:bold; font-size: 16px;">Total Amount: £ <?=$row['total_amount']+$row['vat']+$row['shipping_cost'];?> </span>
                                            </div>
                                        </div>
						...
						<div class="tab-pane fade" id="v-pills-review" role="tabpanel" aria-labelledby="v-pills-review-tab" tabindex="0">
                           ...
                           <div class="tab-pane active in" id="account-orders">
                                <div class="icon-box icon-box-side icon-box-light">
                                    ...
                                    <div class="icon-box-content">
                                        <h4 class="icon-box-title text-capitalize ls-normal mb-4">Referrals</h4>
                                    </div>
                                </div>
