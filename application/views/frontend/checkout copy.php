...
$vat = $subtotal * $vat_rate; // VAT on products + shipping
 $usertotalpayable = $subtotal + $vat; // Subtotal including VAT
}
									...
									<form class="form checkout-form" id="shipping_details" action="" onsubmit="return false;" method="post">
										<div class="review-form">
											...
											<div class="review-form-name">
												...
												<input type="text" id="full_name" name="full_name" class="form-control" placeholder="Full Name" value="<?php if ($billing->num_rows() > 0) {
											...
											<div class="account-inner-form mt-4">
												<div class="review-form-name">
													...
													<input type="email" name="email" id="email" class="form-control"
														placeholder="user@gmail.com" value="<?php if ($billing->num_rows() > 0) {
												...
												<div class="review-form-name">
													...
													<input type="tel" id="phone" class="form-control"
														placeholder="+880388**0899" value="<?php if ($billing->num_rows() > 0) {
												...
												<select id="country" name="country" required class="form-select">
													...
													<?php $countries = $this->db->select("*")->from('app_countries')->order_by('country_name', 'asc')->get()->result_array();
														foreach ($countries as $country) { ?>
															<option value="<?= $country['country_name']; ?>" <?php if ($billing->num_rows() > 0) { if ($billing->row()->country == $country['country_name']) { echo 'selected'; } } ?>><?= $country['country_name']; ?></option>
														<?php } ?>
												</select>
											</div>
											...
											<div class="review-form-name address-form">
												...
												<input type="text" name="address" id="address" class="form-control"
													placeholder="Enter your Address" value="<?php if ($billing->num_rows() > 0) { echo $billing->row()->address; } ?>" required>
											</div>
											...
											<div class=" account-inner-form">
												<div class="review-form-name city-form">
													...
													<input type="text" id="city" name="city" class="form-control"
														placeholder="Enter your City" value="<?php if ($billing->num_rows() > 0) { echo $billing->row()->city; } ?>" required>
												</div>
												<div class="review-form-name zipcode-form">
													<label for="address" class="form-label">Postal Code <span style="color:red">*</span></label>
													<input type="text" id="zipcode" name="zipcode" class="form-control"
														placeholder="Enter your postal code" value="<?php if ($billing->num_rows() > 0) { echo $billing->row()->zipcode; } ?>" required>
												</div>
											</div>
											...
											<input type="hidden" value="<?php $payable = $usertotalpayable - $user['balance'];
