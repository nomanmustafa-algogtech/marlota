                                        ...
                                        <table  class="table dt-responsive nowrap w-100 basic-datatable">
                                                            ...
                                                            <tbody class="row_position">
                                                                ...
                                                                <tr id="<?php echo $row['id']; ?>" style="cursor: move;">
                                                                    <td><?=$row['id'];?></td>
                                                                    <td><?=$row['name'];?></td>
                                                                    <td><img src="<?=base_url();?>uploads/brands/<?=$row['logo'];?>" style="height: 50px;" /></td>
                                                                    
                                                                   
                                                                    <td>
                                                                       
                                                                        <button type="button" onclick="window.location.href='<?=base_url();?>admin/products/edit_brand/<?=$row['id'];?>';" class="btn btn-success btn-bordered rounded-pill btn-xs waves-effect waves-light"><i class="ri-edit-box-line"></i></button>
                                                                        <button type="button" onclick="if(confirm('Are you sure you want to delete this brand?')){ window.location.href='<?=base_url();?>admin/products/brand_delete/<?=$row['id'];?>'; }" class="btn btn-danger btn-bordered rounded-pill btn-xs waves-effect waves-light"><i class="ri-delete-bin-line"></i></button>
                                                    ...
                                                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" id="name" name="name" class="form-control" placeholder="e.g Acer" required>
                                                            </div>
                                                        </div>
                                                        <div class="mb-2 row">
