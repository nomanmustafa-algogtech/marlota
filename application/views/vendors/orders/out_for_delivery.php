                                ...
                                <div class="row" style="margin-bottom:10px">
                                    ...
                                    <div class="col-12" style="display:flex;justify-content: right;">
                                        ...
                                        <select id="charCount" class="form-control" style="width:40%; margin-left:10px; margin-right:10px" name="status" required>
                                            ...
                                            <option value="100">Delivered/Completed</option>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                        <div class="card-title" style="font-size: 20px;"><input type="checkbox" name="orderid[]" value="<?=$order['id'];?>"> Order # <?=$order['id'];?><br>
