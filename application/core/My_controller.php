...
class My_controller extends CI_Controller
{
    ...
    {
        $data['css'] = array(
    		$this->Gen->get_web_url_new('css/swiper10-bundle.min.css'),
    		$this->Gen->get_web_url_new('css/bootstrap-5.3.2.min.css'),
    		$this->Gen->get_web_url_new('css/nouislider.min.css'),
    		$this->Gen->get_web_url_new('css/aos-3.0.0.css'),
    		$this->Gen->get_web_url_new('css/style.css'),
		);
        $data['js'] = array(
            $this->Gen->get_web_url_new('js/jquery_3.7.1.min.js'),
            $this->Gen->get_web_url_new('js/bootstrap_5.3.2.bundle.min.js'),
            $this->Gen->get_web_url_new('js/nouislider.min.js'),
            $this->Gen->get_web_url_new('js/aos-3.0.0.js'),
            $this->Gen->get_web_url_new('js/swiper10-bundle.min.js'),
            $this->Gen->get_web_url_new('js/shopus.js'),
        );
        
        $header = "frontend/layouts/header";
        $footer = "frontend/layouts/footer";
